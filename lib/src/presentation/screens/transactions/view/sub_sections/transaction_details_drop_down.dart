...
class TransactionDetailsDropDown extends StatefulWidget {
  final Transactions transaction;

  const TransactionDetailsDropDown({super.key, required this.transaction});

  @override
  State<TransactionDetailsDropDown> createState() =>
      _TransactionDetailsDropDownState();
}

class _TransactionDetailsDropDownState
    extends State<TransactionDetailsDropDown> {
